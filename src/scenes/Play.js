class Play extends Phaser.Scene {
    ...
    create() {
        ...
        this.timeMiddle = this.add.text(game.config.width / 3 + borderUISize + borderPadding, borderUISize + borderPadding * 2, timeRemaining, scoreConfig);
    ...
    update() {
        ...
        // update timer
        this.timeMiddle.text = timeRemaining;
